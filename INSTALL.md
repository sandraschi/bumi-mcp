...
4. Start the server:
   ...
   uv run python -m bumi_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn bumi_mcp.server:app --port 10774
   ```
5. Open `http://localhost:10774` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/bumi-mcp/issues) |
