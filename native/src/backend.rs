...
const BACKEND_NAME: &str = "bumi-mcp-backend.exe";
const BACKEND_PORT: u16 = 10774;
const BACKEND_TAG: &str = "bumi-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "BUMI_MCP_PORT";
const ENV_HOST: &str = "BUMI_MCP_HOST";
const ENV_TAURI: &str = "BUMI_MCP_TAURI";
